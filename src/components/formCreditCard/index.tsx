...
export default function FormCreditCard() {
  ...
  return (
    <form onSubmit={handleSubmit} className='w-full flex flex-col gap-5'>
      ...
      <button
        type='submit'
        className='bg-80e142 hover:bg-9fe870 hover:scale-105 text-0e0f0c font-semibold text-base w-full h-12 flex items-center justify-center text-center rounded-[30px] transition-all duration-300'
      >
